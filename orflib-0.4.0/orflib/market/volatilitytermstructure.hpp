...
/** Enumeration for volatility type */
enum class VolType
{
  SPOTVOL,
  FWDVOL
...
public:
  ...
  /** Templated constructor from times to maturity and corresponding volatilities */
  ...
  /** Returns the spot volatility at time tMat */
  double spotVol(double tMat) const;

  /** Returns the forward volatility between times tMat1 and tMat2 */
