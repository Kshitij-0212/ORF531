...
static
PyObject* pyOrfWorstOfDigiBSMC(PyObject* pyDummy, PyObject* pyArgs)
{
PY_BEGIN;
  ...
  // create the product
  size_t nassets = spots.size();
  orf::SPtrProduct spprod(new orf::WorstOfDigitalCallPut(payoffType, strike, timeToFix, timeToExp, nassets));
  // create the pricer
  orf::MultiAssetBsMcPricer bsmcpricer(spprod, spyc, divYields, vols, spots, correlMat, mcparams);
  // create the statistics calculator
  orf::MeanVarCalculator<double *> sc(bsmcpricer.nVariables());
